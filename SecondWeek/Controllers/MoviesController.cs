...
namespace SecondWeek.Controllers
{
    ...
    {
        private readonly SecondWeekContext _context;

        public MoviesController(SecondWeekContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString)
        {
            ...
            {
                return Problem("Entity set 'SecondWeekContext.Movie' is null. ");
            }
            ...
            var movieGenreVM = new MovieGenreViewModel
            {
                ...
                Moviess = await movies.ToListAsync()
        };
